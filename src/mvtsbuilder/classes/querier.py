...
Module description details
    ...
    Querier is one player in FAIRstream workflow, inherited from Player class. 
...
from mvtsbuilder.classes.player import Player
from mvtsbuilder.functions.init_csv_source_dict import *
from mvtsbuilder.functions.init_variable_dict import *
from mvtsbuilder.functions.update_csv_source_dict import *
from mvtsbuilder.functions.update_sql_source_dict import *
from mvtsbuilder.functions.update_variable_dict import *
from mvtsbuilder.functions.cmp_src_csv import *
from mvtsbuilder.functions.create_csv_pool import *


class Querier(Player):
    
    def __init__(self, work_dir):
        Player.__init__(self, work_dir)
